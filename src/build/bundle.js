...
/***/ function(module, exports, __webpack_require__) {
	...
	var moment = __webpack_require__(12); // 时间格式化
	moment.locale('zh-cn');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\youhui.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// <script>
	var storage = __webpack_require__(135);
	module.exports = {
		data: function data() {
			return {
				appName: 'VueApp',
				navItems: [{ text: '优惠', link: '/youhui' }, { text: '海淘', link: '/haitao' }, { text: '发现', link: '/faxian' }, { text: '原创', link: '/yuanchuang' }, { text: '资讯', link: '/zixun' }],
				slideItems: [{ image: '//eimg.smzdm.com/201512/18/5673e592470586446.png', link: '://alexbai.githut.io' }, { image: '//eimg.smzdm.com/201512/18/5673e56bc72ad7183.jpg', link: '' }, { image: '//eimg.smzdm.com/201512/18/567367923ebdd7381.png', link: '' }, { image: '//eimg.smzdm.com/201512/18/5673e6540b1894931.png', link: '' }, { image: '//eimg.smzdm.com/201512/18/5673e592470586446.png', link: '://alexbai.githut.io' }],
				topics: [],
				searchKey: {
					page: 1,
					limit: 20,
		...
		computed: {
			...
			wScrollObj: function wScrollObj() {
		...
		methods: {
			...
			getMoreTopics: function getMoreTopics(event) {
				var _self = this;
				if (_self.canScroll) {
					var cHeight = _self.clientHeight,
					    wsHeight = _self.wScrollObj.scrollHeight,
					    wsTop = _self.wScrollObj.scrollTop;
		...
		components: {
			'header-component': __webpack_require__(137),
			'nav-component': __webpack_require__(145),
			'slide-component': __webpack_require__(149)
		}
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $              = __webpack_require__(107)
	  ...
	  , DESCRIPTORS    = __webpack_require__(110)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(107).setDesc
	  , has = __webpack_require__(109)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(124)
	  , getNames  = __webpack_require__(107).getNames
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ajax = __webpack_require__(136);
	module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\components\\header.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 			background: url('//m.smzdm.com/resources/img/icons.png') no-repeat center;
	...
	module.exports = {
		...
		methods: {
			openNavMenu: function openNavMenu() {
				...
				// document.querySelector('.youhui-lists').classList.add('scroll-hide');
		...
		components: {
			'menu-component': __webpack_require__(140)
		}
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\components\\menu.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports) {
	...
	// 	<ul class="nav-menu" :class="{'nav-menu-transiton': showMenu}">

	// 		<li class="nav-menu-item"><a v-link="{ path: '/youhui' }">全部</a></li>
...
/***/ function(module, exports) {
	...
	module.exports = "<ul class=\"nav-menu\" :class=\"{'nav-menu-transiton': showMenu}\">\r\n\t\t<li class=\"nav-menu-item\"><a v-link=\"{ path: '/youhui' }\">全部</a></li>\r\n\t\t<li class=\"nav-menu-item\"><a v-link=\"{ path: '/youhui' }\">全部</a></li>\r\n\t\t<li class=\"nav-menu-item\"><a v-link=\"{ path: '/youhui' }\">全部</a></li>\r\n\t\t<li class=\"nav-menu-item\"><a v-link=\"{ path: '/youhui' }\">全部</a></li>\r\n\t\t<li class=\"nav-menu-item\"><a v-link=\"{ path: '/youhui' }\">全部</a></li>\r\n\t</ul>";

/***/ },
/* 144 */
/***/ function(module, exports) {

	module.exports = "<div v-if=\"showMenu\" @click=\"closeNavMenu\" class=\"page-cover\"></div>\r\n\t<header class=\"header\" :class=\"{'header-transition': showMenu}\">\r\n\t\t<h1>{{ appName }}</h1>\r\n\t\t<span @click=\"openNavMenu\" class=\"icon-nav\">导航</span>\r\n\t</header>\r\n\t<menu-component :show-menu.sync=\"showMenu\"></menu-component>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\components\\nav.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports) {
	...
	module.exports = "<nav class=\"navigator\">\r\n\t\t<a v-link=\"{path: nav.link}\" v-for=\"nav in navItems\" class=\"nav-item\">\r\n\t\t\t{{ nav.text }}\r\n\t\t</a>\r\n\t</nav>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\components\\slide.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports) {
	...
	module.exports = "<div :style=\"{width: deviceWidth + 'px'}\" class=\"slide\">\r\n\t\t<div :style=\"{transform: 'translate3d(' + w + 'px, 0, 0)'}\" class=\"slide-items\">\r\n\t\t\t<a v-for=\"slideitem in slideItems\" :href=\"slideitem.link\" :style=\"{width: deviceWidth + 'px'}\" class=\"slide-item\"><img :src=\"slideitem.image\" alt=\"slide\"></a>\r\n\t\t</div>\r\n\t\t<nav class=\"slide-navs\">\r\n\t\t\t<span v-for=\"item in slideItems\" :class=\"{active: ($index + 1) === i}\"></span>\r\n\t\t</nav>\r\n\t</div>";

/***/ },
/* 153 */
/***/ function(module, exports) {

	module.exports = "<header-component :app-name='appName'></header-component>\r\n    <!-- <nav-component :nav-items=\"navItems\"></nav-component> -->\r\n    <!-- <slide-component :slide-items=\"slideItems\"></slide-component> -->\r\n\t<div class=\"youhui-lists\">\r\n\t\t<a v-for=\"item in topics\" class=\"youhui\" href=\"javascript:;\">\r\n\t\t\t<h3 class=\"youhui-title\" title=\"{{ item.tab }}\">{{ item.title }}</h3>\r\n\t\t\t<div class=\"youhui-content\">\r\n\t\t\t\t<img :src=\"item.author['avatar_url']\" alt=\"头像\" class=\"youhui-avatar\">\r\n\t\t\t\t<div class=\"youhui-detail\">\r\n\t\t\t\t\t<p><span class=\"avatar-pic\">{{ item.author.loginname }}</span><span class=\"reply-num\"><i>{{ item.reply_count }}</i>/{{ item.visit_count }}</span></p>\r\n\t\t\t\t\t<p><span>{{ item.create_at | getTimeStr true}}</span><span>{{ item.last_reply_at | getTimeStr true}}</span></p>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</a>\t\t\r\n\t</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\haitao.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
